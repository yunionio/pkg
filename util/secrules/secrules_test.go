...
func TestIsFunction(t *testing.T) {
	cases := []struct {
		...
		{s: "in:allow 0.0.0.0/0 any", s2: "in:allow 0.0.0.0/0 any"},
		{s: "in:allow ::/0 any", s2: "in:allow ::/0 any"},
		{s: "in:allow tcp", s2: "in:allow tcp"},
		{s: "in:allow 0.0.0.0/0 tcp", s2: "in:allow 0.0.0.0/0 tcp"},
		{s: "in:allow ::/0 tcp", s2: "in:allow ::/0 tcp"},
		{s: "in:allow udp", s2: "in:allow udp"},
		{s: "in:allow 0.0.0.0/0 udp", s2: "in:allow 0.0.0.0/0 udp"},
		{s: "in:allow ::/0 udp", s2: "in:allow ::/0 udp"},
		{s: "in:allow icmp", s2: "in:allow icmp"},
		{s: "in:allow 0.0.0.0/0 icmp", s2: "in:allow 0.0.0.0/0 icmp"},
		{s: "in:allow ::/0 icmp", s2: "in:allow ::/0 icmp"},
		{s: "in:allow 10.0.8.0/24 any", s2: "in:allow 10.0.8.0/24 any"},
		{s: "in:allow fd:3ffe:3200:1220::/64 any", s2: "in:allow fd:3ffe:3200:1220::/64 any"},
		...
		{s: "in:allow fd:3ffe:3200:8::/64 tcp 1-100", s2: "in:allow fd:3ffe:3200:8::/64 tcp 1-100"},
		...
		{s: "in:allow :: tcp", s2: "in:allow :: tcp"},
		{s: "in:allow 0.0.0.0 udp", s2: "in:allow 0.0.0.0 udp"},
		{s: "in:allow :: udp", s2: "in:allow :: udp"},
		{s: "in:deny", bad: true},
		{s: "in:allow", bad: true},
